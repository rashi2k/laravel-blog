            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            @if(Route::current()->getName() != 'home' && Route::current()->getName() != 'index')<li><a class="nav-link" href="{{ url('/') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a></li>@endif
                            @can(['user-list'])
